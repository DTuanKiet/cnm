...
<body>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <?php
                        include_once("View/TH/thuonghieu.php");
                        ?>
                    </div>
                </nav>
            </div>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            if (isset($_SESSION["dn"])) {
                                ...
                                echo '<a href="?dangxuat" onclick="return confirm(\'Bạn có chắc muốn đăng xuất?\');">Đăng xuất</a>';
                            } else {
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 pb-3">
            ...
            } elseif (isset($_GET["chitietsanpham"]) && isset($_GET["id"])) {
                include_once("View/SP/chitietsanpham.php");
            } elseif (isset($_GET["thanhtoan"])) {
                include_once("Controller/cThanhToan.php");
            } elseif (isset($_GET["action"]) && $_GET["action"] === "hoanthanh") {
                include_once("Controller/cHoanThanh.php");
            } else {
                include_once("View/SP/sanpham.php");
            }
            ?>
        </div>
    </div>
